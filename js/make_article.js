...
var bigCrossRight = new Climb("Big Cross Right", 4, 'p', 'crimp', "DNA", 12, 13, 2016, "http://i.imgur.com/lxIqrUn.jpg");
climbs.push(bigCrossRight);

var pinchCrimp25 = new Climb("Pinch Crimp 25", 2, 'blu', 'power', 'MDG', 5, 10, 2016, "http://i.imgur.com/fwuxaqi.jpg");
climbs.push(pinchCrimp25);

var gonzo = new Climb("Gonzo", 3, 'o', 'crimp', 'MDG', 5, 10, 2016, "http://i.imgur.com/O7ECFVz.jpg");
climbs.push(gonzo)

var loafs = new Climb("Loafs", 4, 'p', 'power', 'MDG', 2, 16, 2017, "http://i.imgur.com/ApD0Iqw.jpg")
climbs.unshift(loafs);

var stinkyPinky = new Climb("Stinky Pinky", 2, 'blu', 'power', 'MDG', 2, 23, 2017, "http://i.imgur.com/gHtDkfg.jpg");
climbs.unshift(stinkyPinky);

var woodMixed = new Climb("Wood Mixed", 3, 'o', 'crimp', 'MDG', 5, 10, 2016, "http://i.imgur.com/gLLYYfy.jpg");
climbs.push(woodMixed);

var pinchPinch25 = new Climb("Pinch Pinch 25", 2, 'blu', 'power', 'MDG', 5, 10, 2016, "http://i.imgur.com/HEN3o6R.jpg");
climbs.push(pinchPinch25);

var pullPow = new Climb("Pull Pow", 3, 'o', 'power', 'MDG', 5, 10, 2016, "http://i.imgur.com/mPQmTd6.jpg");
climbs.push(pullPow);

var bigPull25 = new Climb("Big Pull 25", 2, 'blu', 'power', 'MDG', 5, 10, 2016, "http://i.imgur.com/HlwVy6W.jpg");
climbs.push(bigPull25);

var obeyGravity = new Climb("Obey Gravity", 3, 'o', 'power', 'MDG', 5, 10, 2016, "http://i.imgur.com/5enasSN.jpg");
climbs.push(obeyGravity);

var dyno = new Climb("Dyno", 2, 'blu', 'oneMover', 'MDG', 5, 10, 2016, "http://i.imgur.com/tstmYED.jpg");
climbs.push(dyno);

var theFuture = new Climb("The Future (hold for 3 sec)", 2, 'blu', 'oneMover', 'MDG', 5, 10, 2016, "http://i.imgur.com/EXo4DXl.jpg");
climbs.push(theFuture);

var pinchTrifecta = new Climb("Pinch Trifecta", 1, '0', 'power', 'NUG', 5, 10, 2016, "http://i.imgur.com/72862T0.jpg");
climbs.push(pinchTrifecta);

var scarabs = new Climb("Scarabs", 1, '0', 'crimp', 'NUG', 5, 10, 2016, "http://i.imgur.com/skMeQJF.jpg");
climbs.push(scarabs);

var bn1 = new Climb("BN1", 1, '0', 'crimp', 'NUG', 5, 10, 2016, "http://i.imgur.com/rFAXEtU.jpg");
climbs.push(bn1);

var bn2 = new Climb("BN2", 1, '0', 'power', 'NUG', 5, 10, 2016, "http://i.imgur.com/0vR8H5l.jpg");
climbs.push(bn2);

var bn3 = new Climb("BN3", 1, '0', 'power', 'NUG', 5, 10, 2016, "http://i.imgur.com/4MXTb5r.jpg");
climbs.push(bn3);

var bn4 = new Climb("BN4", 1, '0', 'crimp', 'NUG', 5, 10, 2016, "http://i.imgur.com/6LglAb2.jpg");
climbs.push(bn4);

var bn5 = new Climb('BN5', 1, '0', 'crimp', 'NUG', 5, 10, 2016, "http://i.imgur.com/TM0YD46.jpg");
climbs.push(bn5);

var bn6 = new Climb('BN6', 3, 'o', 'power', 'NUG', 5, 10, 2016, "http://i.imgur.com/N5uuhRn.jpg");
climbs.push(bn6);

var bn7 = new Climb("BN7", 3, 'o', 'crimp', 'NUG', 5, 10, 2016, "http://i.imgur.com/wxeGL6F.jpg");
climbs.push(bn7);

var bn8 = new Climb("BN8", 1, '0', 'power', 'NUG', 5, 10, 2016, "http://i.imgur.com/0SE4fvH.jpg");
climbs.push(bn8);

var noShoes = new Climb("No Shoes", 1, '0', 'crimp', 'NUG', 5, 10, 2016, "http://i.imgur.com/WI3GFEM.jpg");
climbs.push(noShoes);
...
var brianWins = new Climb("Brian Wins", 1, '0', 'power', 'NUG', 5, 10, 2016, "http://i.imgur.com/uWE5oYx.jpg");
climbs.push(brianWins);

var bumpDyno = new Climb("Bump Dyno (bump to finish hold)", 1, '0', 'oneMover', 'NUG', 5, 10, 2016, "http://i.imgur.com/8zW8fIF.jpg");
climbs.push(bumpDyno);

var campus = new Climb("Campus", 1, '0', 'crimp', 'NUG', 5, 10, 2016, "http://i.imgur.com/8H7F1uO.jpg");
climbs.push(campus);

var crimpterbator = new Climb("Crimpterbator", 1, '0', 'enduro', 'NUG', 5, 10, 2016, "http://i.imgur.com/sDKlkCv.jpg");
climbs.push(crimpterbator);

var pinchShuffle = new Climb("Pinch Shuffle", 3, 'o', 'power', 'NUG', 5, 10, 2016, "http://i.imgur.com/avf0hHa.jpg");
climbs.push(pinchShuffle);

var marksProj = new Climb("Mark's Proj", 3, 'o', 'oneMover', 'NUG', 5, 10, 2016, "http://i.imgur.com/HNrAS5q.jpg");
...
var pinchPunch = new Climb("Pinch Punch", 4, 'p', 'power', "MDG", 3, 2, 2017, "http://i.imgur.com/ZP4bFn5.jpg");
climbs.unshift(pinchPunch);

var CSS = new Climb("CSS", 4, 'p', 'power', "MDG", 3, 19, 2017, "http://i.imgur.com/VxbESLA.jpg");
climbs.unshift(CSS);

var HTML = new Climb("HTML", 4, 'p', 'power', "MDG", 3, 19, 2017, "http://i.imgur.com/2AyoGBs.jpg");
climbs.unshift(HTML);

var JS = new Climb("JS", 4, 'p', 'crimp', "MDG", 3, 19, 2017, "http://i.imgur.com/ztQin95.jpg");
climbs.unshift(JS);

var moon6b = new Climb("Moon 6B", 3, 'o', 'power', "MDG", 3, 19, 2017, "http://i.imgur.com/PMFpw9O.jpg");
