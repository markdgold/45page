...
function makeClimbs(){
	for(i=0; i<climbs.length; i++){
		...
		for(j=0; j<climbs[i].styles.length; j++){
		 	climbArticle.className += " " + climbs[i].styles[j];
		};
...
var pinchCrimp25 = new Climb("Pinch Crimp 25", 6, ['crimp', 'power'], 'MDG', 5, 10, 2016, "http://i.imgur.com/fwuxaqi.jpg");
climbs.push(pinchCrimp25);

var gonzo = new Climb("Gonzo", 7, ['crimp'], 'MDG', 5, 10, 2016, "http://i.imgur.com/O7ECFVz.jpg");
climbs.push(gonzo)

var loafs = new Climb("Loafs", 9, ['openHand', 'power'], 'MDG', 2, 16, 2016, "http://i.imgur.com/ApD0Iqw.jpg")
climbs.unshift(loafs);

var stinkyPinky = new Climb("Stinky Pinky", 6, ['power'], 'MDG', 2, 23, 2016, "http://i.imgur.com/gHtDkfg.jpg");
...
var pinchPinch25 = new Climb("Pinch Pinch 25", 6, ['openHand', 'power'], 'MDG', 5, 10, 2016, "http://i.imgur.com/HEN3o6R.jpg");
climbs.push(pinchPinch25);

var pullPow = new Climb("Pull Pow", 7, ['power'], 'MDG', 5, 10, 2016, "http://i.imgur.com/mPQmTd6.jpg");
climbs.push(pullPow);

var bigPull25 = new Climb("Big Pull 25", 6, ['power', 'openHand'], 'MDG', 5, 10, 2016, "http://i.imgur.com/HlwVy6W.jpg");
climbs.push(bigPull25);

var obeyGravity = new Climb("Obey Gravity", 7, ['power', 'openHand'], 'MDG', 5, 10, 2016, "http://i.imgur.com/5enasSN.jpg");
climbs.push(obeyGravity);

var dyno = new Climb("Dyno", 6, ['power', 'oneMover'], 'MDG', 5, 10, 2016, "http://i.imgur.com/tstmYED.jpg");
climbs.push(dyno);
...
var pinchPunch = new Climb("Pinch Punch", 9, ['power', 'openHand'], "MDG", 3, 2, 2017, "http://i.imgur.com/ZP4bFn5.jpg");
